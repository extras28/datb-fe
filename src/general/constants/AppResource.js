...
const AppResource = {
  ...
  images: {
    ...
    imgLogoText: require('assets/images/EShip/img_shipee_logo_text.png'),
    imgDefaultLogo: require('assets/images/EShip/img_default_logo.jpeg'),
    imgDefaultAvatar: require('assets/images/EShip/img_default_avatar.png'),
    imgAuthenticationBg: require('assets/images/EShip/img_authentication_bg.png'),
    imgAuthenticationBgMobile: require('assets/images/EShip/img_authentication_bg_mobile.png'),
    imgEmpty: require('assets/images/EShip/img_empty.png'),
    imgUpload: require('assets/images/EShip/img_upload.png'),
    imgLogo: require('assets/images/EShip/img_logo.png'),
    imgLogoTextWhite: require('assets/images/EShip/img_logo_white.png'),
    imgCardStat: require('assets/images/EShip/img_bg_card_stat.png'),
    imgEmptyView: require('assets/images/EShip/img_empty_view.png'),
    imgSpx: require('assets/images/EShip/img_spx.png'),
    imgJt: require('assets/images/EShip/img_jt.png'),
    imgGhn: require('assets/images/EShip/img_ghn.png'),
    imgGhtk: require('assets/images/EShip/img_ghtk.png'),
    imgVnp: require('assets/images/EShip/img_vnp.png'),
    imgVtp: require('assets/images/EShip/img_vtp.png'),
  },
